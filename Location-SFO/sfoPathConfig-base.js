var SFOSelectFromNextPathOptionsBase = function(currentCar, validPathTransitions) {
/*  
...
var SFOCreatePathsBase = function() {
  var previousPath;
  ...
  createPathLine(600,  200,  600,  20, 6, [],          null,                                      "Test",                        0, true, true);

  pathTransitions.push(new PathTransition(findPathByNames(["E Begin", "End"]),      findPathByNames(["W Begin", "Start"]), []));  
  pathTransitions.push(new PathTransition(findPathByNames(["W Begin", "End"]),      findPathByNames(["E Begin", "Start"]), []));  
